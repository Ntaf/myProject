...
Name: singer
Version: 0.2.7
Release: SNAPSHOT20180623114926
Summary: singer
License: (c) null
...
Prefix: /usr/local
BuildArch: noarch
BuildRoot: /home/user14/demo_bin/target/rpm/singer/buildroot
...
if [ -d $RPM_BUILD_ROOT ];
then
  mv /home/user14/demo_bin/target/rpm/singer/tmp-buildroot/* $RPM_BUILD_ROOT
else
  mv /home/user14/demo_bin/target/rpm/singer/tmp-buildroot $RPM_BUILD_ROOT
fi
